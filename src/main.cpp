...
// configuration step. It creates a namespace called `cpp_term`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_term::cmake::project_name, cpp_term::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_term::cmake::project_version);
      return EXIT_SUCCESS;
    }
